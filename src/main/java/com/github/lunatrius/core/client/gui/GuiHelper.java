...
public class GuiHelper {
	...
	public static void drawTexturedRectangle(BufferBuilder buffer, double x0, double y0, double x1, double y1,
	                                         double z,
	...
	public static void drawColoredRectangle(BufferBuilder buffer, double x0, double y0, double x1, double y1, double z,
	                                        int argb) {
		int a = (argb >> 24) & 0xFF;
		int r = (argb >> 16) & 0xFF;
		int g = (argb >> 8) & 0xFF;
	...
	public static void drawVerticalGradientRectangle(BufferBuilder buffer, double x0, double y0, double x1, double y1,
	                                                 double z, int sr, int sg, int sb, int sa, int er, int eg, int eb,
	                                                 int ea) {
	...
	public static void drawVerticalGradientRectangle(BufferBuilder buffer, double x0, double y0, double x1, double y1,
	                                                 double z, int startColor, int endColor) {
	...
	public static void drawHorizontalGradientRectangle(BufferBuilder buffer, double x0, double y0, double x1,
	                                                   double y1,
	                                                   double z, int startColor, int endColor) {
		int sa = (startColor >> 24) & 255;
		int sr = (startColor >> 16) & 255;
	...
	public static void drawHorizontalGradientRectangle(BufferBuilder buffer, double x0, double y0, double x1,
	                                                   double y1,
	                                                   double z, int sr, int sg, int sb, int sa, int er, int eg,
	                                                   int eb,
	                                                   int ea) {
		buffer.pos(x0, y0, z).color(sr, sg, sb, sa).endVertex();
