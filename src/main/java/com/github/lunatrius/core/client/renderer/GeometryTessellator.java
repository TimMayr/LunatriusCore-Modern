...
public class GeometryTessellator extends Tessellator {
	...
	public static void drawQuads(BufferBuilder buffer, double x0, double y0, double z0, double x1, double y1,
	                             double z1,
	                             int sides, int argb) {
		int a = (argb >>> 24) & 0xFF;
		int r = (argb >>> 16) & 0xFF;
	...
	public static void drawLines(BufferBuilder buffer, double x0, double y0, double z0, double x1, double y1,
	                             double z1,
	                             int sides, int argb) {
		int a = (argb >>> 24) & 0xFF;
		int r = (argb >>> 16) & 0xFF;
